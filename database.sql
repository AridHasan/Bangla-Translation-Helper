...
"CREATE TABLE IF NOT EXISTS verified_sentences(
vId bigint UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
uId bigint UNSIGNED NOT NULL,
sId bigint UNSIGNED NOT NULL,
...
FOREIGN KEY (sId) REFERENCES sentences(sId)
   ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY (tId) REFERENCES translated(tId)
   ON UPDATE CASCADE ON DELETE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=utf8 DEFAULT COLLATE utf8_general_ci";

"CREATE TABLE IF NOT EXISTS verification_skip(
skipId bigint UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
sId bigint UNSIGNED NOT NULL,
uId bigint UNSIGNED NOT NULL,
tId bigint UNSIGNED NOT NULL,
